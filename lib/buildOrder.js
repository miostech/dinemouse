...
function buildSubscription(cart, phones) {
    const tierKey = (cart.subscription && cart.subscription.tier) || 'mensal';
    ...
    const userData = {
        ...
        subscription: { active: true, name: tier.label, price: tier.amount, billing: 'monthly' },
        plan: { type: 'alerts', name: tier.label, price: tier.amount, alerts: 0, billing: 'monthly' },
        alerts: [],
    };
