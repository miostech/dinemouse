...
// Alerta URGENTE (mesmo dia): produto separado, preço fixo. Monitoramento
// acelerado para pegar cancelamentos de última hora.
const SAME_DAY_PRICE = 50;

/** Preço de 1 alerta avulso conforme a antecedência (dias até a data). */
function priceByDaysAhead(daysAhead) {
    if (daysAhead <= 0) return SAME_DAY_PRICE; // mesmo dia = alerta urgente
