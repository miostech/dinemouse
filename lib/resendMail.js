 ...
 *
 * @param {{ to: string, resetUrl: string, logoUrl?: string }}}
 */
async function sendPasswordResetEmail({ to, resetUrl, logoUrl }) {
  ...
  <img src="${escapeHtmlAttr(logoUrl.trim())}" alt="Dine Mouse" width="160" height="auto" style="max-width:160px;height:auto;display:inline-block;border:0;" />
</div>`
            : '';
